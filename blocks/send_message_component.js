module.exports = {
    ...
    async code(cache) {
        ...
        if(type == "send") {
            channel.send({ flags: flags, content: msg ? msg : undefined, embeds: embed ? [embed] : undefined, files: file ? [file] : undefined, components: comps ? comps : undefined}).then( msg => {
            ...
            channel.reply({ flags: flags, content: msg ? msg : undefined, embeds: embed ? [embed] : undefined, files: file ? [file] : undefined, components: comps ? comps : undefined}).then( msg => {
                this.StoreOutputValue(msg, "message", cache);
                this.RunNextBlock("action", cache);
                return
            })
